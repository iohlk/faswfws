...
send(msg.chat_id,msg.id,"➢ مرحبا عزيزي في مصنع الحمايه المجاني لسورس بلاك كوست \n➢ مبرمج السورس @Q0OO0","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
Redis:del(black..msg.sender.user_id.."make:bot")
send(msg.chat_id,msg.id,
[[ الاوامر المذكوره بالشرح

معرف بوت فاذر @botfather
...
-----
-------
ملاحظه : جميع الاوامر عند الضغط عليها يتم نسخها الى الحافظه التي لديك
]],"md",true
)
return false 
end
...
----
if text == 'المطور ستفين' or text == 'مبرمج السورس' or text == 'ستفين' then  
...
{
{text = 'B𝗹𝗮𝗰𝗸 G𝗵𝗼𝘀𝘁', url = "https://t.me/lB8BBB"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/lB8BBB"
local T =[[
    ⦑ Welcome to Source ⦒
    ✯ [⦑ 𝔹𝕃𝔸ℂ𝕂 𝔾ℍ𝕆𝕊𝕋 ⦒](http://t.me/lB8BBB)
    ✯ Source version : 1.0
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '. قناة السورس -', url = 't.me/lB8BBB'}, 
},
{
{text = '. لتنصيب البوت -', url = 't.me/Q0OO0'},
{text = '. تحديثات السورس -',url='t.me/O0lO00'}
},
{
{text = '. كروب سورس بلاك كوست -', url = 't.me/HHHHuw'}, 
},
{
{text = '. تواصل السورس -', url = 't.me/ToAsEl1bOt'},
{text = '. مطور السورس -',url='t.me/O0lO00'}
},
}
